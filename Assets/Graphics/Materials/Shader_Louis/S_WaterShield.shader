...
Shader "S_WaterShield"
{
	Properties
	{
		...
		_desapearValue("desapearValue", Range( 0 , 3)) = 0.2
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 tex2DNode56 = tex2D( _WaterShieldTexture, panner61 );
			float2 temp_cast_0 = (tex2DNode56.r).xx;
			o.Emission = tex2D( _Texture1, temp_cast_0 ).rgb;
			float saferPower49 = max( ( 1.0 - i.vertexColor.r ) , 0.0001 );
			float2 uv_TexCoord44 = i.uv_texcoord * float2( 1.5,1.5 );
			float2 panner45 = ( 0.3 * _Time.y * float2( 1,0.2 ) + uv_TexCoord44);
			float2 panner47 = ( 0.2 * _Time.y * float2( 0.5,0.4 ) + i.uv_texcoord);
			float clampResult75 = clamp( ( step( _appearValue , ( i.vertexColor.r - ( pow( saferPower49 , 0.8 ) * tex2D( _Texture0, panner45 ).r * tex2D( _Texture0, panner47 ).r ) ) ) - ( ( i.vertexColor.r * _desapearValue ) + 0.2 ) ) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18000
0;6;1920;1013;885.2538;-325.1927;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;51;-1366.284,399.1993;Inherit;False;1800.837;745.1136;Opacity Gestion;18;44;48;45;47;42;1;46;49;43;2;39;40;13;3;72;84;85;86;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;42;-1151.636,629.3751;Inherit;True;Property;_Texture0;Texture 0;3;0;Create;True;0;0;False;0;805af41b6e803c748bc9986722ba9df2;805af41b6e803c748bc9986722ba9df2;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.PannerNode;45;-1027.859,901.7455;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;1,0.2;False;1;FLOAT;0.3;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PannerNode;47;-892.2513,476.3435;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0.5,0.4;False;1;FLOAT;0.2;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.PowerNode;49;-102.8705,825.9933;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT;0.8;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;86;-354.2538,450.1927;Inherit;False;Property;_desapearValue;desapearValue;7;0;Create;True;0;0;False;0;0.2;2.4;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;13;4.20199,1098.194;Inherit;False;Property;_appearValue;appearValue;2;0;Create;True;0;0;False;0;1;0.2;0.2;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;72;38.9887,568.9211;Inherit;False;Constant;_Float0;Float 0;6;0;Create;True;0;0;False;0;0.2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StepOpNode;3;295.1882,621.1267;Inherit;True;2;0;FLOAT;0.02;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;59;-271.8347,-658.5689;Inherit;True;Property;_Texture1;Texture 1;6;0;Create;True;0;0;False;0;4edf59f9699caef46970d85e32231dd6;4edf59f9699caef46970d85e32231dd6;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;58;-294.1346,-310.2689;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;27;-150.8896,1637.156;Inherit;False;Property;_Float1;Float 1;0;0;Create;True;0;0;False;0;0.01;0.01;0.01;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;32;-530.1707,1465.131;Inherit;False;Property;_Float2;Float 2;1;0;Create;True;0;0;False;0;1;10;1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;64;-259.5491,19.70618;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;26;40.77793,1379.466;Inherit;False;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;688.2255,100.4783;Float;False;True;-1;2;ASEMaterialInspector;0;0;Unlit;S_WaterShield;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Off;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;False;0;True;Transparent;;AlphaTest;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;4;-1;-1;-1;0;True;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=5F31C282A9019ACA283ED342740722491C3DB614